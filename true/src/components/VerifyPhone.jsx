      ...
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Enter the OTP sent to <strong className="text-blue-600">{phone}</strong>
          </p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleVerify}>
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 text-center text-xl font-semibold border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
              required
              maxLength={6}
            />
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="text-blue-600 hover:text-blue-700 font-medium transition-colors disabled:text-blue-400"
            >
              Resend OTP
            </button>
          </div>
